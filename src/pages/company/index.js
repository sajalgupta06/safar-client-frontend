      ...
      <div className="com_frame">
        ...
        <div className="com_frame-center">
              ...
              <Slider {...settings} ref={sliderRef} className="slider"> 
                  ...
                  <div className="singleDestination" >
                    <div className="destImage">
                      ...
                      <img src="https://images.unsplash.com/photo-1605649487212-47bdab064df7?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8aGltYWNoYWx8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="img Title" className="" />
          ...
          <div className="com_frame-center-bottom">
            ...
            <div id="gallery">
              <div>
                <img src="https://picsum.photos/600/600/?img=512" />
                <a href="#lightbox-1">512</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=513" />
                <a href="#lightbox-2">513</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=514" />
                <a href="#lightbox-3">514</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=515" />
                <a href="#lightbox-4">515</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=516" />
                <a href="#lightbox-5">516</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=517" />
                <a href="#lightbox-6">517</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=518" />
                <a href="#lightbox-7">518</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=519" />
                <a href="#lightbox-8">519</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=520" />
                <a href="#lightbox-9">520</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=521" />
                <a href="#lightbox-10">521</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=522" />
                <a href="#lightbox-11">522</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=523" />
                <a href="#lightbox-12">523</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=524" />
                <a href="#lightbox-13">524</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=525" />
                <a href="#lightbox-14">525</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=526" />
                <a href="#lightbox-15">526</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=527" />
                <a href="#lightbox-16">527</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=528" />
                <a href="#lightbox-17">528</a>
              </div>
              <div>
                <img src="https://picsum.photos/600/600/?img=529" />
                <a href="#lightbox-18">529</a>
              </div>
            </div>
            <div className="lightbox" id="lightbox-1">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=512" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-2">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=513" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-3">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=514" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-4">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=515" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-5">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=516" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-6">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=517" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-7">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=518" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-8">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=519" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-9">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=520" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-10">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=521" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-11">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=522" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-12">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=523" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-13">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=524" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-14">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=525" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-15">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=526" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-16">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=527" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-17">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=528" />
                <div className="title">
            ...
            <div className="lightbox" id="lightbox-18">
              <div className="content">
                <img src="https://picsum.photos/1920/1080/?img=529" />
                <div className="title">
